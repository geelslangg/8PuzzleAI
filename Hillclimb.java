public class Hillclimb {
                        ...
                        for (int y = 0; y < 3; y++) {
                            if (initial[b][c][a] == goal[x][y]) {
                                if (initial[b][c][a] == 0) {
                                    ...
                                    // System.out.println("Start " + xInitial + "," + yInitial + " -> " + xGoal +
                                    // "," + yGoal + " End");
    ...
    //write a function to order values from smallest to biggest but values of -1 go at the back
            ...
            for (int b = 0; b < number; b++) {
                if (openList[b] != null) {
                    ...
                    if (openList[b + 1].getHeuristic() < temp.getHeuristic()) {
                        if(openList[b + 1].getHeuristic() == -1) {
                            openList[b+1].addToHeuristic(100000);
                            //openList[b + 1] = temp;
                        }
                        else {
    ...
    public static boolean hillClimbAlgorithm(puzzleNode initial, int[][] goal) // hill climb algorithm function
    {
        ...
        while (open[0] != null && state != true) {
            ...
            if (temp.getString().compareTo(goalString) == 0) {
                ...
                if (XZero == 1 && YZero == 1) {
                    ...
                    for (int b = 0; b < 4; b++) {
                        ...
                        if (inOpen(compareString) == false && inClosed(compareString) == false) {
                            ...
                            // childrenStates[b].setPath(gN);
                            childrenStates[b].updateHeuristic(-1);
                    ...
                    if (childrenStates[0].getHeuristic() == childrenStates[1].getHeuristic()
                            && childrenStates[1].getHeuristic() == childrenStates[2].getHeuristic()
                            && childrenStates[2].getHeuristic() == childrenStates[3].getHeuristic()) {
                                childrenStates[0].updateHeuristic(100000);
                        ...
                        // childrenStates[2].addToHeuristic(100);
                        ...
                        // break;
                        addClosed(temp);
                        // System.out.println("childrenStates: " + childrenStates[0].getHeuristic() + "
                        // " + childrenStates[1].getHeuristic() + " " + childrenStates[2].getHeuristic()
                        // + " " + childrenStates[3].getHeuristic());
                        childrenStates = reorderNodes(childrenStates, 4);
                ...
                } else if (XZero == 0 && YZero == 1 || XZero == 1 && YZero == 2 || XZero == 2 && YZero == 1
                        || XZero == 1 && YZero == 0) {
                    ...
                    if (childrenStates[0].getHeuristic() == childrenStates[1].getHeuristic()
                        ...
                        // childrenStates[2].addToHeuristic(10);
